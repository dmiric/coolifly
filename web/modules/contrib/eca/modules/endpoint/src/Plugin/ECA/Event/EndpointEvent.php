...
class EndpointEvent extends EventBase {
  ...
  #[Token(
    ...
    properties: [
      new Token(name: 'path-arguments', description: 'The arguments of the request path.'),
      new Token(name: 'request', description: 'The request.', properties: [
        ...
        new Token(name: 'content-type', description: 'The content type of the request.'),
