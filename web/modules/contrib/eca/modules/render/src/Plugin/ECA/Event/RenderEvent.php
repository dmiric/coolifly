...
class RenderEvent extends EventBase implements PluginUsageInterface {
  ...
  #[Token(
    ...
    properties: [
      ...
      new Token(name: 'extra-field-name', description: 'The name of the extra field.', classes: [
        EcaRenderExtraFieldEvent::class,
      ]),
      ...
      new Token(name: 'route-parameters', description: 'The route parameters.', classes: [
        EcaRenderContextualLinksEvent::class,
      ]),
      new Token(name: 'view-display', description: 'The current display of the view.', classes: [
        EcaRenderViewsFieldEvent::class,
      ]),
      new Token(name: 'view-id', description: 'The view ID.', classes: [
        EcaRenderViewsFieldEvent::class,
      ]),
    ]
  )]
  protected function buildEventData(): array {
    ...
    if ($event instanceof EcaRenderContextualLinksEvent) {
      $data += [
        ...
        'route-parameters' => $event->getRouteParameters(),
      ];
    }
    ...
    elseif ($event instanceof EcaRenderExtraFieldEvent) {
      $data += [
        'extra-field-name' => $event->getExtraFieldName(),
    ...
    elseif ($event instanceof EcaRenderViewsFieldEvent) {
      $data += [
        ...
        'view-id' => $event->getFieldPlugin()->view->id(),
        'view-display' => $event->getFieldPlugin()->view->current_display,
      ];
    }
