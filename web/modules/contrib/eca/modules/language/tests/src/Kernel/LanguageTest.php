...
class LanguageTest extends KernelTestBase {
  ...
  public function testLanguage(): void {
    ...
    // 1. It reacts upon language negotation.
   ...
   */
  public function testLanguageNegotationUrl(): void {
    ...
    $eca_config_values = [
      ...
      'events' => [
        'language_negotiation_url' => [
          ...
          'label' => 'Language negotiation url',
          'configuration' => [
            'event_id' => 'language_negotation_url',
          ],
          'successors' => [
            ['id' => 'set_german_language', 'condition' => ''],
          ],
    ...
    $this->container->get('event_dispatcher')->dispatch(new CustomEvent('language_negotation_url'), BaseEvents::CUSTOM);
