...
trait EntityDiffTrait {
  ...
  public function doBuildConfigurationForm(array $form, FormStateInterface $form_state): array {
    ...
    $form['include_fields'] = [
      ...
      '#description' => $this->t('List machine names of fields that should be considered for comparisson. Provide 1 name per line. Leave this field empty to include all fields, except for the excluded fields.'),
